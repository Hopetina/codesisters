...
Discover talented developers at PlutoDev - where the next generation of tech talent is built! 💻✨`;
  ...
  if (selectedProject) {
    const projectTitle = `${selectedProject.user.name || 'Developer'}'s Project | CodeSisters Sister Spotlight`;
            ...
            <Card className="bg-gradient-to-r from-purple-600 to-pink-600 text-white">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-purple-100 mb-6 text-lg">
                  ...
                  Connect with talented women developers like {selectedProject.user.name || "them"} through CodeSisters.
                </p>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      <Helmet>
        <title>CodeSisters Sister Spotlight - Discover Amazing Women Developers</title>
        <meta name="description" content="Discover talented women developers and their amazing projects at CodeSisters. See real portfolios from our sisterhood - perfect for employers and investors looking for diverse tech talent." />
      </Helmet>
